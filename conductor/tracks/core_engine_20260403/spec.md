...
## Out of Scope
- Alien AI and movement patterns.
- Collision detection logic.
- High score persistence and menu system.

## Success Criteria
- The game loop runs at a consistent frame rate.
- The player can move laterally within defined boundaries.
- Projectiles are spawned and move upward on input.
